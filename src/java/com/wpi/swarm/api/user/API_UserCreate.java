 ...
 * @author jtste
 */
@WebServlet(name = "API_UserCreate", urlPatterns = {"/api/json/user/create"})
public class API_UserCreate extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("application/json");
        MCon m = new MCon();
        if (User.createUser(m, request.getParameter("user"), request.getParameter("pass"), request.getParameter("rec"))) {
