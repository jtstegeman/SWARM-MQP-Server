 ...
 * @author jtste
 */
@WebServlet(name = "API_Node_TimeFrame", urlPatterns = {"/api/node/history"})
public class API_Node_History extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        List<Node> nds = nc.getNodeDataInRange(id, key, after, before);
        if (nds == null) {
            obj.add("status", "err");
        } else {
