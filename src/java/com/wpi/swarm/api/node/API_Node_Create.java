 ...
 * @author jtste
 */
@WebServlet(name = "API_Node_Create", urlPatterns = {"/api/node/create"})
public class API_Node_Create extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (Authorizer.authorizeUser(m, request)) {
            ...
            Node n = nc.createNode(Authorizer.getUsername(request), name, lat, lng);
            if (n == null) {
                obj.add("status", "err");
            } else {
